    ...
    <div className="min-h-screen bg-void bg-scan-grid">
          ...
          <div className="flex justify-between h-16 items-center">
            <div className="flex items-center gap-8">
              <div className="flex items-center gap-2.5">
                ...
                <span className="text-slate-900 font-display font-semibold tracking-tight">
                  CaviNet
                </span>
              </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex items-center gap-2.5 mb-1">
          ...
          <span className="text-cyan-700 text-[11px] font-mono uppercase tracking-[0.15em]">
            System online
          </span>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mt-6">
          ...
          <div className="bg-panel border border-slate-900/[0.06] rounded-xl p-6 shadow-sm shadow-slate-900/[0.02]">
            <h3 className="text-slate-500 text-xs font-mono uppercase tracking-wider mb-4">
              Quick access
            </h3>
